...
export const parseHttpMethod = (method: string): HttpMethod | null => {
  const normalizedMethod = method.toUpperCase()
  return HTTP_METHODS.includes(normalizedMethod as HttpMethod)
    ? (normalizedMethod as HttpMethod)
    : null
}
...
export const parseContentType = (contentType: string): ContentType | null => {
