...
import { setUpDirectory } from "../../../io"
import { useInjected } from "../../../container"
import { Project, updateLastModified } from "../../domain/project"

import { Layout } from "./Layout"
import { CreateProjectModal } from "./CreateProjectModal/CreateProjectModal"

import type { Store } from "@scenario-flow/util/lib"
...
export const IndexPage = ({ store }: IndexPageProps) => {
  ...
  return (
    ...
    >
      <Core projectContext={projectContext} store={store} injected={injected} />
    </Layout>
  )
}
